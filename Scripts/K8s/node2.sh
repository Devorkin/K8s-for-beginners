...
# For example:
# sudo kubeadm join 192.168.70.8:6443 \
# --token 56j969.6jgjdjauvvckdx50 \
# --discovery-token-ca-cert-hash sha256:ebc2ec8ceb8a1ffc2573346e7f82f617689d0ac91fd48c2f407b329276110b16
